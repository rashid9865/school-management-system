...
<div class="panel-card" style="max-width: 1180px; margin: 2rem auto; padding: 2rem; background: #ffffff; border-radius: 24px; box-shadow: 0 20px 45px rgba(41, 50, 57, 0.08);">
    <div class="panel-header" style="display:flex; justify-content:space-between; gap:1rem; align-items:flex-start; margin-bottom:1.5rem;">
        <div>
            <p class="eyebrow" style="margin:0; color:#6b7280; font-size:.95rem; letter-spacing:.04em; text-transform:uppercase;">Fee collection</p>
            <h2 style="margin:.4rem 0 0; color:#111827;">Collect student fees</h2>
            <p style="margin:.6rem 0 0; color:#4b5563;">Mark pending student fees as paid directly from this page.</p>
        </div>
    </div>
        ...
        <table class="data-table" style="width:100%; border-collapse:collapse;">
            <thead>
                <tr style="background:#f8fafc; text-align:left;">
                    ...
                    <th style="padding:1rem; color:#4b5563; text-transform:uppercase; letter-spacing:.02em;">Action</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr style="border-bottom:1px solid #e5e7eb;">
                    ...
                    <td style="padding:1rem;">
                        <form action="{{ route('fee.collect.store', $fee->id) }}" method="POST" style="display:inline-block;">
                            @csrf
                            <button type="submit" style="background:#4338ca; color:#fff; border:none; padding:.75rem 1.15rem; border-radius:999px; cursor:pointer;">Mark Paid</button>
                        </form>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" style="padding:1.5rem; text-align:center; color:#6b7280;">No pending fees available.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
