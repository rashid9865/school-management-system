    ...
    <div class="reports-card">
        <div class="reports-card-header">
            <div class="reports-card-title">
                <span class="eyebrow">Fee analytics</span>
                <h1>Fee Reports</h1>
                <p>Comprehensive overview of all fee payments and pending amounts</p>
            </div>
            <span class="reports-badge">{{ $fees->count() }} records</span>
        </div>
                    ...
                    <table class="data-table">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-tag me-1"></i>Rule</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($fees as $fee)
                            <tr>
                                ...
                                <td>{{ $fee->feeStructure?->type ? ucfirst(str_replace('_', ' ', $fee->feeStructure->type)) : 'Custom' }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
